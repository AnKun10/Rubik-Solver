...
class ColorDetector:
    ...
    def color_detecting(self):
        ...
        while True:
            ...
            # Calculate start and end coordinates to crop the smaller central part
            ...
            # Crop the smaller central part of the camera frame
            cropped_frame = frame[start_y:end_y, start_x:end_x]

            # Create a copy of the frame to draw color grid
            ...
            # Draw the 3x3 grid and small squares within each large square
            for i in range(cube_size):
                for j in range(cube_size):
                    # Coordinates of the large square
                    ...
                    # Coordinates of the small square inside the large square
            ...
            # Display the cropped camera frame with the 3x3 grid and small squares
